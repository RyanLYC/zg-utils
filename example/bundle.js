(function () {
  ...
  */
  ...
  const getUrlParams = (url = window.location.href, name) => {
    const jsonMaps = {};
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("div", null, [
          ...
          _hoisted_1$1,
          createBaseVNode("div", null, "click count\uFF1A" + toDisplayString(valueRef.value), 1)
        ]);
      };
    }
  });

  script$2.__file = "examples/useEventListener/demo.vue";
  ...
  var script$1 = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("div", null, [
          createBaseVNode("div", null, "Window size change\uFF1A" + toDisplayString(valueRef.value), 1)
        ]);
      };
    }
  });

  script$1.__file = "examples/useEventListener/demo1.vue";

  const _withScopeId = (n) => (pushScopeId("data-v-1ebcac49"), n = n(), popScopeId(), n);
  const _hoisted_1 = { class: "page-bx" };
  const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h3", null, "UseEventListener - Demo", -1));
  var script = /* @__PURE__ */ defineComponent({
    __name: "App",
    setup(__props) {
      console.log(getUrlParams("https://examples.com/base/path?name=Bob&age=24&sex=0"));
      return (_ctx, _cache) => {
  ...
  var css_248z = "*[data-v-1ebcac49]{padding:0;margin:0}.page-bx[data-v-1ebcac49]{width:100%;height:100vh}\n";
  styleInject(css_248z);

  script.__scopeId = "data-v-1ebcac49";
  script.__file = "examples/App.vue";
